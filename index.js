...
const baseSongs = [
    { id: 0, path: 'assets/laviem.mp3', displayName: 'La Viem', cover: 'assets/11.png', artist: 'SoundCloud' },
    { id: 1, path: 'assets/timem.mp3', displayName: 'Time', cover: 'assets/10.png', artist: 'SoundCloud' },
    { id: 2, path: 'assets/ty1d.mp3', displayName: 'Tôi Rất Nhớ Bạn', cover: 'assets/6.png', artist: 'SoundCloud' },
    { id: 3, path: 'assets/biendaovaem.mp3', displayName: 'Biển Đảo Và Em', cover: 'assets/7.png', artist: 'SoundCloud' },
    { id: 4, path: 'assets/mashup.mp3', displayName: 'Mashup Chill', cover: 'assets/5.png', artist: 'SoundCloud' },
    ...
    { id: 8, path: 'assets/denkhinao.mp3', displayName: 'Đến Khi Nào', cover: 'assets/ly.png', artist: 'Artist' },
